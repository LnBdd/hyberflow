...
the two recesses on the inside of the cover **(21)** and insert tube adapters **(29)** using thread sealing tape.
%%% Apply sealing tape if the connection isnt water tight
